...
const translations: Record<string, { en: string; ar: string }> = {
  ...
  // Home
  'home.badge': { en: 'Trusted B2B Marketplace for Iraq', ar: 'سوق B2B موثوق للعراق' },
  'home.title': { en: 'Find Manufacturers & Suppliers in Iraq', ar: 'اعثر على المصنعين والموردين في العراق' },
  'home.subtitle': { en: 'Discover products, machinery, materials, and manufacturing companies from suppliers across Iraq.', ar: 'اكتشف المنتجات والآلات والمواد والشركات المصنعة من الموردين في جميع أنحاء العراق.' },
  ...
  'home.browseCategories': { en: 'Browse Categories', ar: 'تصفح الفئات' },
  'home.browseCategoriesSub': { en: 'Find products by industry category', ar: 'اعثر على المنتجات حسب فئة الصناعة' },
  ...
  'home.popularSuppliers': { en: 'Popular Suppliers', ar: 'موردون مشهورون' },
  'home.popularSuppliersSub': { en: 'Trusted manufacturing companies', ar: 'شركات تصنيع موثوقة' },
  'home.recent': { en: 'Recently Added Products', ar: 'منتجات مضافة حديثاً' },
  'home.ctaTitle': { en: 'Are You a Supplier?', ar: 'هل أنت مورد؟' },
  'home.ctaBody': { en: 'Join Sanadiq and showcase your products to thousands of buyers across Iraq. Create your company profile, list your products, and start receiving inquiries.', ar: 'انضم إلى صناديق واعرض منتجاتك على آلاف المشترين في جميع أنحاء العراق. أنشئ ملف شركتك، أدرج منتجاتك، وابدأ في تلقي الاستفسارات.' },
  'home.ctaJoin': { en: 'Join as a Supplier', ar: 'انضم كمورد' },
